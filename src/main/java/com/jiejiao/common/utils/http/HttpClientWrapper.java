...
public class HttpClientWrapper {
	...
	public ResponseContent getResponse(String urlstr, String urlEncoding, VERBTYPE bodyType)
	 ...
	 * @throws IOException
	 */
	private ResponseContent getRedirect(String baseURL, HttpMethodBase method, int redirectCount)
			throws HttpException, IOException {
		if (method == null)
			return null;
